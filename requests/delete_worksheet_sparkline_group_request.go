...
func NewDeleteWorksheetSparklineGroupRequest(name string, sheetName string, sparklineIndex int, opts ...Option) *DeleteWorksheetSparklineGroupRequest {
...
func (request *DeleteWorksheetSparklineGroupRequest) Validate() error {
	if request.name == "" {
...
func (request *DeleteWorksheetSparklineGroupRequest) AddQueryParameter(key, value string) {
...
func (request *DeleteWorksheetSparklineGroupRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
...
func (request *DeleteWorksheetSparklineGroupRequest) GetPath() string {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"sparklineIndex"+"}", url.PathEscape(fmt.Sprintf("%v", request.sparklineIndex)), -1)
	return localVarPath
}
