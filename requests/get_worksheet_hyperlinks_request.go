...
func (request *GetWorksheetHyperlinksRequest) Validate() error {
	if request.name == "" {
...
func (request *GetWorksheetHyperlinksRequest) AddQueryParameter(key, value string) {
...
func (request *GetWorksheetHyperlinksRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
