...
func NewRemoveSpreadsheetBlankColumnsRequest(Spreadsheet string, opts ...RequestOption) *RemoveSpreadsheetBlankColumnsRequest {
...
func (request *RemoveSpreadsheetBlankColumnsRequest) Description() {
