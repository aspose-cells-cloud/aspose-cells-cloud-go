...
func (request *DeleteWorksheetValidationRequest) Validate() error {
	if request.name == "" {
...
func (request *DeleteWorksheetValidationRequest) AddQueryParameter(key, value string) {
...
func (request *DeleteWorksheetValidationRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
