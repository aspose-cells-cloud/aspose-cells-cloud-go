...
func (request *SummarizeSpreadsheetRequest) Validate() error {
...
func (request *SummarizeSpreadsheetRequest) AddQueryParameter(key, value string) {
...
func (request *SummarizeSpreadsheetRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
