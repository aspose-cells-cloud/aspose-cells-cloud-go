...
func (request *PostWorkbookDataCleansingRequest) Validate() error {
	if request.dataCleansing == nil {
		return fmt.Errorf("required request parameter %q is missing", "dataCleansing")
	}
