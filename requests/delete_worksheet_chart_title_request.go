...
func (request *DeleteWorksheetChartTitleRequest) Validate() error {
	if request.name == "" {
...
func (request *DeleteWorksheetChartTitleRequest) AddQueryParameter(key, value string) {
...
func (request *DeleteWorksheetChartTitleRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
