...
func (request *ConvertTableToJsonRequest) Validate() error {
...
func (request *ConvertTableToJsonRequest) AddQueryParameter(key, value string) {
...
func (request *ConvertTableToJsonRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
