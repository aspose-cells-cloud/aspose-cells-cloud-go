...
func (request *GetWorksheetSparklineGroupsRequest) Validate() error {
	if request.name == "" {
...
func (request *GetWorksheetSparklineGroupsRequest) AddQueryParameter(key, value string) {
...
func (request *GetWorksheetSparklineGroupsRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
