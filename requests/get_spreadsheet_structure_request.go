...
func (request *GetSpreadsheetStructureRequest) AddQueryParameter(key, value string) {
...
func (request *GetSpreadsheetStructureRequest) AddQueryParameters(params map[string]string) {
    if request.extraQueryParameters == nil {
        request.extraQueryParameters = make(map[string]string)
    }
