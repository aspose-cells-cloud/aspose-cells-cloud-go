...
func (request *ConvertSpreadsheetRequest) Validate() error {
	if request.format == "" {
...
func (request *ConvertSpreadsheetRequest) SetSpreadsheetBytes(data []byte, name string) {
	if name == "" {
		name = "Spreadsheet"
	}
...
func (request *ConvertSpreadsheetRequest) GetHeaderParameters() map[string]string {
...
func (request *ConvertSpreadsheetRequest) GetQueryParameters() url.Values {
...
func (request *ConvertSpreadsheetRequest) GetJSONBody() interface{} {
	return nil
}

func (request *ConvertSpreadsheetRequest) GetMultipartForm() map[string]interface{} {
