...
func (request *PostWorksheetAutoFilterRefreshRequest) Validate() error {
	if request.name == "" {
...
func (request *PostWorksheetAutoFilterRefreshRequest) AddQueryParameter(key, value string) {
...
func (request *PostWorksheetAutoFilterRefreshRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
