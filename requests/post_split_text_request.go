...
func (request *PostSplitTextRequest) Validate() error {
	if request.splitTextOptions == nil {
		return fmt.Errorf("required request parameter %q is missing", "splitTextOptions")
	}
