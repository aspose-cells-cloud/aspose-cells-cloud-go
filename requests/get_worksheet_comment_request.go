...
func (request *GetWorksheetCommentRequest) Validate() error {
	if request.cellName == "" {
...
func (request *GetWorksheetCommentRequest) AddQueryParameter(key, value string) {
...
func (request *GetWorksheetCommentRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
