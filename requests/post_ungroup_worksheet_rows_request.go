...
func (request *PostUngroupWorksheetRowsRequest) Validate() error {
	if request.name == "" {
...
func (request *PostUngroupWorksheetRowsRequest) AddQueryParameter(key, value string) {
...
func (request *PostUngroupWorksheetRowsRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
