...
func (request *GetWorksheetChartLegendRequest) Validate() error {
	if request.name == "" {
...
func (request *GetWorksheetChartLegendRequest) AddQueryParameter(key, value string) {
...
func (request *GetWorksheetChartLegendRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
