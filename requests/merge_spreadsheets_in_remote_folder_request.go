...
func (request *MergeSpreadsheetsInRemoteFolderRequest) Description() string {
    return strings.Trim("Merge spreadsheet files in folder of cloud storage into a specified format file.", " ")
}