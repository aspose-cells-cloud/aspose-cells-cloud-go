...
func (request *GetPivotTableFieldRequest) Validate() error {
	if request.name == "" {
...
func (request *GetPivotTableFieldRequest) AddQueryParameter(key, value string) {
...
func (request *GetPivotTableFieldRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
...
func (request *GetPivotTableFieldRequest) GetMethod() string {
	return "GET"
}

func (request *GetPivotTableFieldRequest) GetHeaderParameters() map[string]string {
	localVarHeaderParams := make(map[string]string)
	localVarHeaderParams["Content-Type"] = "application/json"
	return localVarHeaderParams
}

func (request *GetPivotTableFieldRequest) GetPath() string {
...
func (request *GetPivotTableFieldRequest) GetQueryParameters() url.Values {
	localVarQueryParams := url.Values{}
	localVarQueryParams.Add("pivotFieldIndex", fmt.Sprintf("%v", request.pivotFieldIndex))
...
func (request *GetPivotTableFieldRequest) GetJSONBody() interface{} {
	return nil
}

func (request *GetPivotTableFieldRequest) GetMultipartForm() map[string]interface{} {
