...
func (request *ConvertRangeToPdfRequest) Validate() error {
	if request._range == "" {
...
func (request *ConvertRangeToPdfRequest) SetSpreadsheetBytes(data []byte, name string) {
	if name == "" {
		name = "Spreadsheet"
	}
...
func (request *ConvertRangeToPdfRequest) AddQueryParameter(key, value string) {
...
func (request *ConvertRangeToPdfRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
...
func (request *ConvertRangeToPdfRequest) GetMethod() string {
	return "PUT"
}

func (request *ConvertRangeToPdfRequest) GetHeaderParameters() map[string]string {
...
func (request *ConvertRangeToPdfRequest) GetQueryParameters() url.Values {
...
func (request *ConvertRangeToPdfRequest) GetJSONBody() interface{} {
	return nil
}

func (request *ConvertRangeToPdfRequest) GetMultipartForm() map[string]interface{} {
