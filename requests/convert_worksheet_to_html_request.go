...
type ConvertWorksheetToHtmlRequest struct {
	Spreadsheet     string
...
func (request *ConvertWorksheetToHtmlRequest) Validate() error {
...
func (request *ConvertWorksheetToHtmlRequest) SetSpreadsheetBytes(data []byte, name string) {
	if name == "" {
		name = "Spreadsheet"
	}
...
func (request *ConvertWorksheetToHtmlRequest) AddQueryParameter(key, value string) {
...
func (request *ConvertWorksheetToHtmlRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
...
func (request *ConvertWorksheetToHtmlRequest) GetMethod() string {
	return "PUT"
}

func (request *ConvertWorksheetToHtmlRequest) GetHeaderParameters() map[string]string {
	localVarHeaderParams := make(map[string]string)
	localVarHeaderParams["Content-Type"] = "multipart/form-data"
	return localVarHeaderParams
}

func (request *ConvertWorksheetToHtmlRequest) GetPath() string {
	localVarPath := "/cells/convert/worksheet/html"
	return localVarPath
}

func (request *ConvertWorksheetToHtmlRequest) GetQueryParameters() url.Values {
...
func (request *ConvertWorksheetToHtmlRequest) GetJSONBody() interface{} {
	return nil
}

func (request *ConvertWorksheetToHtmlRequest) GetMultipartForm() map[string]interface{} {
