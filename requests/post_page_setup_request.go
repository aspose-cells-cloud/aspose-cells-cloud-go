...
func (request *PostPageSetupRequest) Validate() error {
	if request.name == "" {
		return fmt.Errorf("required request parameter %q is missing", "name")
	}

	if request.pageSetup == nil {
		return fmt.Errorf("required request parameter %q is missing", "pageSetup")
	}
...
func (request *PostPageSetupRequest) AddQueryParameter(key, value string) {
...
func (request *PostPageSetupRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
