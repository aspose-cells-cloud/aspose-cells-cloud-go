...
func (request *PostWorksheetCellsRangeStyleRequest) Validate() error {
	if request.name == "" {
...
func (request *PostWorksheetCellsRangeStyleRequest) AddQueryParameter(key, value string) {
...
func (request *PostWorksheetCellsRangeStyleRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
