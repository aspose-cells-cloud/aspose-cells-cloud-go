...
func (request *PostSetCellHtmlStringRequest) Validate() error {
	if request.cellName == "" {
...
func (request *PostSetCellHtmlStringRequest) AddQueryParameter(key, value string) {
...
func (request *PostSetCellHtmlStringRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
