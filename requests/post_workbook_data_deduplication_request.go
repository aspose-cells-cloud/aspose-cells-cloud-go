...
func (request *PostWorkbookDataDeduplicationRequest) Validate() error {
	if request.deduplicationRegion == nil {
		return fmt.Errorf("required request parameter %q is missing", "deduplicationRegion")
	}
