...
func (request *GetMergedCellsInRemotedWorksheetRequest) Description() string {
    return strings.Trim("Get all merged cell area form a remote spreadsheet worksheet.", " ")
}