...
func NewConvertWorksheetToImageRequest(format string, Spreadsheet string, worksheet string, opts ...Option) *ConvertWorksheetToImageRequest {
    req := &ConvertWorksheetToImageRequest{
        format: format,
...
func (request *ConvertWorksheetToImageRequest) SetSpreadsheetBytes(data []byte, name string) {
    if name == "" {
        name = "Spreadsheet"
    }
...
func (request *ConvertWorksheetToImageRequest) GetHeaderParameters() map[string]string {
...
func (request *ConvertWorksheetToImageRequest) GetQueryParameters() url.Values {
...
func (request *ConvertWorksheetToImageRequest) GetJSONBody() interface{} {
    return nil
}

func (request *ConvertWorksheetToImageRequest) GetMultipartForm() map[string]interface{} {
...
func (request *ConvertWorksheetToImageRequest) Description() string {
    return strings.Trim("Converts a worksheet of spreadsheet on a local drive to the image format.", " ")
}