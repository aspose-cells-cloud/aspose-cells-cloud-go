...
func (request *ConvertWorksheetToImageRequest) Description() {
    fmt.Println(strings.Trim("Converts a worksheet of spreadsheet on a local drive to the image format.", " "))
}