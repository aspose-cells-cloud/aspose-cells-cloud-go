...
func (request *PostWorksheetCellsRangeSortRequest) Validate() error {
	if request.name == "" {
		return fmt.Errorf("required request parameter %q is missing", "name")
	}

	if request.rangeSortRequest == nil {
		return fmt.Errorf("required request parameter %q is missing", "rangeSortRequest")
	}
