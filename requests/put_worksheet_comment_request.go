...
func (request *PutWorksheetCommentRequest) Validate() error {
	if request.cellName == "" {
...
func (request *PutWorksheetCommentRequest) AddQueryParameter(key, value string) {
...
func (request *PutWorksheetCommentRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
