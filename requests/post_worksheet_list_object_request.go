...
func (request *PostWorksheetListObjectRequest) Validate() error {
	if request.listObject == nil {
		return fmt.Errorf("required request parameter %q is missing", "listObject")
	}
