...
func (request *PostBatchProtectRequest) Validate() error {
	if request.batchProtectRequest == nil {
		return fmt.Errorf("required request parameter %q is missing", "batchProtectRequest")
	}
