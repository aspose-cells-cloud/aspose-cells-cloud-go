...
func (request *ExportRangeAsFormatRequest) Validate() error {
	if request.format == "" {
...
func (request *ExportRangeAsFormatRequest) AddQueryParameter(key, value string) {
...
func (request *ExportRangeAsFormatRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
