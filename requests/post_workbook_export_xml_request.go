...
func (request *PostWorkbookExportXMLRequest) Validate() error {
	if request.name == "" {
...
func (request *PostWorkbookExportXMLRequest) AddQueryParameter(key, value string) {
...
func (request *PostWorkbookExportXMLRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
...
func (request *PostWorkbookExportXMLRequest) GetMethod() string {
	return "POST"
}

func (request *PostWorkbookExportXMLRequest) GetHeaderParameters() map[string]string {
...
func (request *PostWorkbookExportXMLRequest) GetQueryParameters() url.Values {
...
func (request *PostWorkbookExportXMLRequest) GetJSONBody() interface{} {
	return nil
}

func (request *PostWorkbookExportXMLRequest) GetMultipartForm() map[string]interface{} {
