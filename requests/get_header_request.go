...
func (request *GetHeaderRequest) Validate() error {
	if request.name == "" {
...
func (request *GetHeaderRequest) AddQueryParameter(key, value string) {
...
func (request *GetHeaderRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
