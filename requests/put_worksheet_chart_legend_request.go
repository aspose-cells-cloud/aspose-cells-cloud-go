...
func (request *PutWorksheetChartLegendRequest) Validate() error {
	if request.name == "" {
...
func (request *PutWorksheetChartLegendRequest) AddQueryParameter(key, value string) {
...
func (request *PutWorksheetChartLegendRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
