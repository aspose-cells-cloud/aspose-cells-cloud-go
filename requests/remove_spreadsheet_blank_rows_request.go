...
func NewRemoveSpreadsheetBlankRowsRequest(Spreadsheet string, opts ...Option) *RemoveSpreadsheetBlankRowsRequest {
    req := &RemoveSpreadsheetBlankRowsRequest{
...
func (request *RemoveSpreadsheetBlankRowsRequest) SetSpreadsheetBytes(data []byte, name string) {
    if name == "" {
        name = "Spreadsheet"
    }
...
func (request *RemoveSpreadsheetBlankRowsRequest) GetHeaderParameters() map[string]string {
...
func (request *RemoveSpreadsheetBlankRowsRequest) GetQueryParameters() url.Values {
...
func (request *RemoveSpreadsheetBlankRowsRequest) GetJSONBody() interface{} {
    return nil
}

func (request *RemoveSpreadsheetBlankRowsRequest) GetMultipartForm() map[string]interface{} {
...
func (request *RemoveSpreadsheetBlankRowsRequest) Description() string {
