...
func (request *GetWorksheetPivotTablesRequest) Validate() error {
	if request.name == "" {
...
func (request *GetWorksheetPivotTablesRequest) AddQueryParameter(key, value string) {
...
func (request *GetWorksheetPivotTablesRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
