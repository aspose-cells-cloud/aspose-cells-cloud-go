...
func (request *GetWorksheetListObjectRequest) Validate() error {
	if request.name == "" {
...
func (request *GetWorksheetListObjectRequest) AddQueryParameter(key, value string) {
...
func (request *GetWorksheetListObjectRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
