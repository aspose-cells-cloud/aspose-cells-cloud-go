...
func (request *GetFooterRequest) Validate() error {
	if request.name == "" {
...
func (request *GetFooterRequest) AddQueryParameter(key, value string) {
...
func (request *GetFooterRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
