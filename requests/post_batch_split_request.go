...
func (request *PostBatchSplitRequest) Validate() error {
	if request.batchSplitRequest == nil {
		return fmt.Errorf("required request parameter %q is missing", "batchSplitRequest")
	}
