...
func (request *GetWorksheetAutoFilterRequest) Validate() error {
	if request.name == "" {
...
func (request *GetWorksheetAutoFilterRequest) AddQueryParameter(key, value string) {
...
func (request *GetWorksheetAutoFilterRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
