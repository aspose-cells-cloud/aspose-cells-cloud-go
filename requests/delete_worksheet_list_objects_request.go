...
func (request *DeleteWorksheetListObjectsRequest) Validate() error {
	if request.name == "" {
...
func (request *DeleteWorksheetListObjectsRequest) AddQueryParameter(key, value string) {
...
func (request *DeleteWorksheetListObjectsRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
