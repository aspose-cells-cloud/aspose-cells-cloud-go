...
func (request *PostUpdateWorksheetPropertyRequest) Validate() error {
	if request.name == "" {
		return fmt.Errorf("required request parameter %q is missing", "name")
	}

	if request.sheet == nil {
		return fmt.Errorf("required request parameter %q is missing", "sheet")
	}
...
func (request *PostUpdateWorksheetPropertyRequest) AddQueryParameter(key, value string) {
...
func (request *PostUpdateWorksheetPropertyRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
