...
func (request *PostChartValueAxisRequest) Validate() error {
	if request.axis == nil {
...
func (request *PostChartValueAxisRequest) AddQueryParameter(key, value string) {
...
func (request *PostChartValueAxisRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
