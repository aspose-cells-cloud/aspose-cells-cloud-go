...
func (request *RemoveSpreadsheetBlankWorksheetsRequest) Validate() error {
...
func (request *RemoveSpreadsheetBlankWorksheetsRequest) SetSpreadsheetBytes(data []byte, name string) {
	if name == "" {
		name = "Spreadsheet"
	}
...
func (request *RemoveSpreadsheetBlankWorksheetsRequest) GetHeaderParameters() map[string]string {
...
func (request *RemoveSpreadsheetBlankWorksheetsRequest) GetQueryParameters() url.Values {
...
func (request *RemoveSpreadsheetBlankWorksheetsRequest) GetJSONBody() interface{} {
	return nil
}

func (request *RemoveSpreadsheetBlankWorksheetsRequest) GetMultipartForm() map[string]interface{} {
