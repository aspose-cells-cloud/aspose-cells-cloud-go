...
func (request *ConvertRangeToImageRequest) Validate() error {
	if request.format == "" {
...
func (request *ConvertRangeToImageRequest) AddQueryParameter(key, value string) {
...
func (request *ConvertRangeToImageRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
