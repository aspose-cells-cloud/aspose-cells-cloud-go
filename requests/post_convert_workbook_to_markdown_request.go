...
func (request *PostConvertWorkbookToMarkdownRequest) Validate() error {
...
func (request *PostConvertWorkbookToMarkdownRequest) SetFileBytes(data []byte, name string) {
	if name == "" {
		name = "File"
	}
...
func (request *PostConvertWorkbookToMarkdownRequest) GetHeaderParameters() map[string]string {
...
func (request *PostConvertWorkbookToMarkdownRequest) GetQueryParameters() url.Values {
...
func (request *PostConvertWorkbookToMarkdownRequest) GetJSONBody() interface{} {
	return nil
}

func (request *PostConvertWorkbookToMarkdownRequest) GetMultipartForm() map[string]interface{} {
