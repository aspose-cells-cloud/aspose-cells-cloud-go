...
func (request *ConvertRangeToJsonRequest) Validate() error {
	if request._range == "" {
...
func (request *ConvertRangeToJsonRequest) SetSpreadsheetBytes(data []byte, name string) {
	if name == "" {
		name = "Spreadsheet"
	}
...
func (request *ConvertRangeToJsonRequest) AddQueryParameter(key, value string) {
...
func (request *ConvertRangeToJsonRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
...
func (request *ConvertRangeToJsonRequest) GetMethod() string {
	return "PUT"
}

func (request *ConvertRangeToJsonRequest) GetHeaderParameters() map[string]string {
...
func (request *ConvertRangeToJsonRequest) GetQueryParameters() url.Values {
...
func (request *ConvertRangeToJsonRequest) GetJSONBody() interface{} {
	return nil
}

func (request *ConvertRangeToJsonRequest) GetMultipartForm() map[string]interface{} {
