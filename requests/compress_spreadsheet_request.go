...
func (request *CompressSpreadsheetRequest) Validate() error {
...
func (request *CompressSpreadsheetRequest) SetSpreadsheetBytes(data []byte, name string) {
	if name == "" {
		name = "Spreadsheet"
	}
...
func (request *CompressSpreadsheetRequest) GetHeaderParameters() map[string]string {
...
func (request *CompressSpreadsheetRequest) GetQueryParameters() url.Values {
	localVarQueryParams := url.Values{}
	localVarQueryParams.Add("level", fmt.Sprintf("%v", request.level))
	if request.outPath != "" {
...
func (request *CompressSpreadsheetRequest) GetJSONBody() interface{} {
	return nil
}

func (request *CompressSpreadsheetRequest) GetMultipartForm() map[string]interface{} {
