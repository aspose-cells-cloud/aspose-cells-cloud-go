...
func (request *PostWorksheetListColumnRequest) Validate() error {
	if request.listColumn == nil {
		return fmt.Errorf("required request parameter %q is missing", "listColumn")
	}
