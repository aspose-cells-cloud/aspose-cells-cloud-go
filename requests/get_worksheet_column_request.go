...
func (request *GetWorksheetColumnRequest) Validate() error {
	if request.name == "" {
...
func (request *GetWorksheetColumnRequest) AddQueryParameter(key, value string) {
...
func (request *GetWorksheetColumnRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
