...
func (request *PostUpdateWorksheetRowRequest) Validate() error {
	if request.name == "" {
...
func (request *PostUpdateWorksheetRowRequest) AddQueryParameter(key, value string) {
...
func (request *PostUpdateWorksheetRowRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
