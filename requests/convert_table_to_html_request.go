...
func (request *ConvertTableToHtmlRequest) Validate() error {
...
func (request *ConvertTableToHtmlRequest) SetSpreadsheetBytes(data []byte, name string) {
	if name == "" {
		name = "Spreadsheet"
	}
...
func (request *ConvertTableToHtmlRequest) AddQueryParameter(key, value string) {
...
func (request *ConvertTableToHtmlRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
...
func (request *ConvertTableToHtmlRequest) GetMethod() string {
	return "PUT"
}

func (request *ConvertTableToHtmlRequest) GetHeaderParameters() map[string]string {
...
func (request *ConvertTableToHtmlRequest) GetQueryParameters() url.Values {
...
func (request *ConvertTableToHtmlRequest) GetJSONBody() interface{} {
	return nil
}

func (request *ConvertTableToHtmlRequest) GetMultipartForm() map[string]interface{} {
