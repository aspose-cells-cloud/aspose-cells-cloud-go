...
func (request *PostWorksheetChartRequest) Validate() error {
	if request.chart == nil {
		return fmt.Errorf("required request parameter %q is missing", "chart")
	}
...
func (request *PostWorksheetChartRequest) AddQueryParameter(key, value string) {
...
func (request *PostWorksheetChartRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
