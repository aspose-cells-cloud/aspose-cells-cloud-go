...
func (request *ConvertTableToPdfRequest) Validate() error {
...
func (request *ConvertTableToPdfRequest) SetSpreadsheetBytes(data []byte, name string) {
	if name == "" {
		name = "Spreadsheet"
	}
...
func (request *ConvertTableToPdfRequest) AddQueryParameter(key, value string) {
...
func (request *ConvertTableToPdfRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
...
func (request *ConvertTableToPdfRequest) GetMethod() string {
	return "PUT"
}

func (request *ConvertTableToPdfRequest) GetHeaderParameters() map[string]string {
...
func (request *ConvertTableToPdfRequest) GetQueryParameters() url.Values {
...
func (request *ConvertTableToPdfRequest) GetJSONBody() interface{} {
	return nil
}

func (request *ConvertTableToPdfRequest) GetMultipartForm() map[string]interface{} {
