...
func (request *ExportTableAsFormatRequest) AddQueryParameter(key, value string) {
...
func (request *ExportTableAsFormatRequest) AddQueryParameters(params map[string]string) {
    if request.extraQueryParameters == nil {
        request.extraQueryParameters = make(map[string]string)
    }
...
func (request *ExportTableAsFormatRequest) GetMethod() string {
    return "GET"
}

func (request *ExportTableAsFormatRequest) GetHeaderParameters() map[string]string {
...
func (request *ExportTableAsFormatRequest) GetPath() string {
    ...
    localVarPath = strings.Replace(localVarPath, "{"+"tableName"+"}", fmt.Sprintf("%v", request.tableName), -1)
    return localVarPath
}

func (request *ExportTableAsFormatRequest) GetQueryParameters() url.Values {
...
func (request *ExportTableAsFormatRequest) GetJSONBody() interface{} {
    return nil
}

func (request *ExportTableAsFormatRequest) GetMultipartForm() map[string]interface{} {
