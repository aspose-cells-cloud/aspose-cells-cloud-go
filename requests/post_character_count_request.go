...
func (request *PostCharacterCountRequest) Validate() error {
	if request.characterCountOptions == nil {
		return fmt.Errorf("required request parameter %q is missing", "characterCountOptions")
	}
