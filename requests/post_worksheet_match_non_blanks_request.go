...
func (request *PostWorksheetMatchNonBlanksRequest) Validate() error {
	if request.name == "" {
...
func (request *PostWorksheetMatchNonBlanksRequest) AddQueryParameter(key, value string) {
...
func (request *PostWorksheetMatchNonBlanksRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
