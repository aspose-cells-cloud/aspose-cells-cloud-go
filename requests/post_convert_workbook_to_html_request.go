...
func (request *PostConvertWorkbookToHtmlRequest) Validate() error {
...
func (request *PostConvertWorkbookToHtmlRequest) AddQueryParameter(key, value string) {
...
func (request *PostConvertWorkbookToHtmlRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
