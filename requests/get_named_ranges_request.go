...
func (request *GetNamedRangesRequest) Validate() error {
	if request.name == "" {
...
func (request *GetNamedRangesRequest) AddQueryParameter(key, value string) {
...
func (request *GetNamedRangesRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
