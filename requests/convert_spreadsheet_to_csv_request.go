...
func (request *ConvertSpreadsheetToCsvRequest) Validate() error {
...
func (request *ConvertSpreadsheetToCsvRequest) SetSpreadsheetBytes(data []byte, name string) {
	if name == "" {
		name = "Spreadsheet"
	}
...
func (request *ConvertSpreadsheetToCsvRequest) AddQueryParameter(key, value string) {
...
func (request *ConvertSpreadsheetToCsvRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
...
func (request *ConvertSpreadsheetToCsvRequest) GetMethod() string {
	return "PUT"
}

func (request *ConvertSpreadsheetToCsvRequest) GetHeaderParameters() map[string]string {
...
func (request *ConvertSpreadsheetToCsvRequest) GetQueryParameters() url.Values {
...
func (request *ConvertSpreadsheetToCsvRequest) GetJSONBody() interface{} {
	return nil
}

func (request *ConvertSpreadsheetToCsvRequest) GetMultipartForm() map[string]interface{} {
