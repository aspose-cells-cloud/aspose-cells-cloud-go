...
func (request *DeleteWorkbookBackgroundRequest) AddQueryParameter(key, value string) {
...
func (request *DeleteWorkbookBackgroundRequest) AddQueryParameters(params map[string]string) {
    if request.extraQueryParameters == nil {
        request.extraQueryParameters = make(map[string]string)
    }
