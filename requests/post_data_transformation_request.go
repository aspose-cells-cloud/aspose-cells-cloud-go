...
func (request *PostDataTransformationRequest) Validate() error {
	if request.dataTransformationRequest == nil {
		return fmt.Errorf("required request parameter %q is missing", "dataTransformationRequest")
	}
