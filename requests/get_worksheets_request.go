...
func (request *GetWorksheetsRequest) Validate() error {
	if request.name == "" {
...
func (request *GetWorksheetsRequest) AddQueryParameter(key, value string) {
...
func (request *GetWorksheetsRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
