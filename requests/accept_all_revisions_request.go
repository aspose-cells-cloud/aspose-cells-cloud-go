...
func (request *AcceptAllRevisionsRequest) Validate() error {
...
func (request *AcceptAllRevisionsRequest) SetSpreadsheetBytes(data []byte, name string) {
	if name == "" {
		name = "Spreadsheet"
	}
...
func (request *AcceptAllRevisionsRequest) GetHeaderParameters() map[string]string {
...
func (request *AcceptAllRevisionsRequest) GetQueryParameters() url.Values {
...
func (request *AcceptAllRevisionsRequest) GetJSONBody() interface{} {
	return nil
}

func (request *AcceptAllRevisionsRequest) GetMultipartForm() map[string]interface{} {
