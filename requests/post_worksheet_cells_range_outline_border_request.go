...
func (request *PostWorksheetCellsRangeOutlineBorderRequest) Validate() error {
	if request.name == "" {
		return fmt.Errorf("required request parameter %q is missing", "name")
	}

	if request.rangeOperate == nil {
		return fmt.Errorf("required request parameter %q is missing", "rangeOperate")
	}
...
func (request *PostWorksheetCellsRangeOutlineBorderRequest) AddQueryParameter(key, value string) {
...
func (request *PostWorksheetCellsRangeOutlineBorderRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
