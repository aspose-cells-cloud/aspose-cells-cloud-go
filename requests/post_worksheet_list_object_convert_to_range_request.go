...
func (request *PostWorksheetListObjectConvertToRangeRequest) Validate() error {
	if request.name == "" {
...
func (request *PostWorksheetListObjectConvertToRangeRequest) AddQueryParameter(key, value string) {
...
func (request *PostWorksheetListObjectConvertToRangeRequest) AddQueryParameters(params map[string]string) {
	if request.extraQueryParameters == nil {
		request.extraQueryParameters = make(map[string]string)
	}
